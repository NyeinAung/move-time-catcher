...
class BusScheduleListCreate extends Component{
    constructor(props){
        super(props);
    ...
    handleSubmit(e) {
        ...
        if(this.handleValidation()){
            ...
            axios.post('/bus-schedule/store', BusScheduleListData).then((response) => {
                                                ...
                                                <div className="row">
                                                    <div className="col-12">
                                                        <div className="pr-2 float-left">
                                                            <select className="form-control" name="bus_time_hour" onChange={this.onChange}>
                                                                {hours.map(hour => (
                                                        ...
                                                        <div className="pr-2 float-left">
                                                            <select className="form-control" name="bus_time_mins" onChange={this.onChange}>
                                                                {mins.map(min => (
...
export default BusScheduleListCreate;